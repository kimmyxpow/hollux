<div>
    ...
    <section class="lg:my-40 mt-10 mb-20">
        <div class="container px-8 mx-auto lg:space-y-20 space-y-10">
            <div class="space-y-2">
                ...
                <p class="tracking-wide text-gray-600 sm:text-base text-sm">We provide many types of rooms that you can choose according to your needs. <a href="#" class="underline">Click here to see all options</a></p>
            </div>
                    ...
                    <div class="flex md:flex-row flex-col lg:gap-20 md:gap-10 gap-6 md:items-center h-full">
                        ...
                        <div class="flex flex-col justify-between md:h-full gap-1">
                            ...
                            <span class="flex justify-between items-center">
                                ...
                                <a class="group" href="#"><i class='bx bx-right-arrow-alt lg:text-4xl text-3xl text-gray-600 group-hover:translate-x-2 transition-all duration-300'></i></a>
                            </span>
                        </div>
                    </div>
                @endforeach
    ...
    <section class="lg:my-40 mt-10 mb-20">
        <div class="container px-8 mx-auto space-y-6">
            <div class="space-y-2">
                <h1 class="sm:text-5xl text-gray-800 text-3xl font-['poppins'] font-black capitalize after:content-[''] after:block after:w-10 after:h-1 after:bg-gray-800 after:rounded-full">Galery</h1>
    ...
    <section class="lg:my-40 mt-10 mb-20">
        <div class="container px-8 mx-auto space-y-6 text-center">
            ...
            <button class="btn">View All Rooms</button>
        </div>
    </section>
</div>
